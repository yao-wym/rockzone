...
public class IO {
	 ...
	 *            回调函数
	 */
	public static void put(String uptoken, String key, InputStreamAt isa, PutExtra extra,
			JSONObjectRet ret) {
	 ...
	 *            结果回调函数
	 */
	public static void putFile(Context mContext, String uptoken, String key, Uri uri,
			PutExtra extra, final JSONObjectRet ret) {

		final InputStreamAt isa;
		try {
			isa = InputStreamAt.fromInputStream(mContext, mContext.getContentResolver()
                    .openInputStream(uri));
